...
public class SynchronizedResourceSetImpl extends ResourceSetImpl implements Detachable {
	...
	/* (non-Javadoc)
	 * @see org.gecko.emf.osgi.Detachable#detachFromResource(org.eclipse.emf.ecore.EObject)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.gecko.emf.osgi.Detachable#detachFromAll(org.eclipse.emf.ecore.EObject)
	 */
	@Override
