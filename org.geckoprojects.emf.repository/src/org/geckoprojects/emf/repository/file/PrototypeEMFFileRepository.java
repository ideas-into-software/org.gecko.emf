 ...
 */
package org.geckoprojects.emf.repository.file;
...
public class PrototypeEMFFileRepository extends DefaultEMFRepository {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.geckoprojects.emf.repository.DefaultEMFRepository#activate(java.util.Map)
	 */
	@Override
	@Activate
	...
	/* 
	 * (non-Javadoc)
	 * @see org.geckoprojects.emf.repository.DefaultEMFRepository#deactivate()
	 */
	@Override
	@Deactivate
	...
	/* 
	 * (non-Javadoc)
	 * @see org.geckoprojects.emf.repository.DefaultEMFRepository#setResourceSetFactory(org.geckoprojects.emf.core.ResourceSetFactory)
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see org.geckoprojects.emf.repository.DefaultEMFRepository#setIDs(org.eclipse.emf.ecore.EObject)
	 */
	@Override
