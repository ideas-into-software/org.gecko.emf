...
public class GeckoEmfGeneratorTest {
	...
	/**
	 * Test method for {@link org.geckoprojects.emf.codegen.GeckoEmfGenerator#doGenerate(java.io.File, java.lang.String, java.io.File)}.
	 * @throws IOException 
	 */
	@Test
	public void testDoGenerate() throws IOException {

		URI toSanatize = URI.createURI("resource://org.geckoprojects.emf.codegen.test/../org.eclipse.emf.ecore/model/Ecore.genmodel");
//		URI toResolve = URI.createURI("resource://org.geckoprojects.emf.codegen.test/model/test.genmodel");
//		URI theOther = URI.createURI("resource://org.geckoprojects.emf.codegen.test/");
