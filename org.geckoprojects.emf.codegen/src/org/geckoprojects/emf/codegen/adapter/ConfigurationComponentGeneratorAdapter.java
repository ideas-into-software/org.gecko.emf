...
public class ConfigurationComponentGeneratorAdapter extends GenPackageGeneratorAdapter {
	...
	private static final JETEmitterDescriptor[] JET_EMITTER_DESCRIPTORS =
		{
				new JETEmitterDescriptor("model/ConfigComponent.javajet", "org.geckoprojects.emf.codegen.templates.model.ConfigurationComponentClass"),
				new JETEmitterDescriptor("model/PackageInfo.javajet", "org.geckoprojects.emf.codegen.templates.model.PackageInfo"),
				new JETEmitterDescriptor("model/PackageInfoImpl.javajet", "org.geckoprojects.emf.codegen.templates.model.PackageInfoImpl"),
				new JETEmitterDescriptor("model/PackageInfoUtil.javajet", "org.geckoprojects.emf.codegen.templates.model.PackageInfoUtil")
		};
