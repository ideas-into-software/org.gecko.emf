...
@EMFModel(emf_model_name=ManualPackage.eNAME, emf_model_nsURI={ManualPackage.eNS_URI}, emf_model_version="1.0")
@RequireEMF
@ProvideEMFModel(name = ManualPackage.eNAME, nsURI = { ManualPackage.eNS_URI }, version = "1.0" )
