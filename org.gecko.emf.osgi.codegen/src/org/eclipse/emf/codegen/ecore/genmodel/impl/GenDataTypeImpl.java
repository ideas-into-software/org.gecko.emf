...
public class GenDataTypeImpl extends GenClassifierImpl implements GenDataType
{
  ...
  public String getStaticValue(String literal, boolean includeCast)
  {
    ...
    if(Dependencies.isPureOSGi(getGenPackage())) {

    	result.append(getGenPackage().getFactoryClassName());
    	result.append(".createFromStringStatic(");
    	result.append(getGenPackage().getPackageInterfaceName()); 
    	result.append("."); 
    	result.append(getGenPackage().getClassifierID(this)); 
    	result.append(", "); 
    	...
    	result.append(getGenPackage().getQualifiedEFactoryInstanceAccessor());
