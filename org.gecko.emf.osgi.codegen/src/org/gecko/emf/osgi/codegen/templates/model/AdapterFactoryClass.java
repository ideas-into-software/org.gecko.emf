...
public class AdapterFactoryClass
{
  ...
  protected final String TEXT_16 = NL + "\t/**" + NL + "\t * The cached model package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  ...
  protected final String TEXT_23 = "(modelPackage)" + NL + "\t\t{";
