...
public class ResourceFactoryClass
{
  ...
  protected final String TEXT_50 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * A method providing the Properties the services around this ResourceFactory should be registered with." + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
