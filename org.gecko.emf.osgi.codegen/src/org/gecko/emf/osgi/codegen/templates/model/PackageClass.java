...
public class PackageClass
{
  ...
  protected final String TEXT_80 = NL + "\t// Reference the imported Models" + NL + "\t\t";
  protected final String TEXT_81 = NL + "\t\t\t";
  protected final String TEXT_82 = NL + "\t@";
  protected final String TEXT_83 = " the";
  protected final String TEXT_84 = "; " + NL + "\t\t    ";
  protected final String TEXT_85 = NL + "\t    ";
  protected final String TEXT_86 = NL + NL + "\tprivate ";
  protected final String TEXT_87 = "<";
  protected final String TEXT_88 = "> ePackageConfiguratorRegistration = null;" + NL + "  " + NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL + "\t * @see ";
  protected final String TEXT_89 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_90 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t}" + NL + "" + NL + "    /**" + NL + "\t * Activates and initializes the Package and registers the Package {@link org.gecko.emf.osgi.EPackageConfigurator}." + NL + "\t *" + NL + "     * @generated" + NL + "\t */" + NL + "    @";
  protected final String TEXT_91 = NL + "  \tpublic void activate(";
  protected final String TEXT_92 = " ctx)" + NL + "  \t{" + NL + "  \t    ";
  protected final String TEXT_93 = NL + "\t\t// Initialize simple dependencies" + NL + "\t    ";
  protected final String TEXT_94 = NL + "\t\t";
  protected final String TEXT_95 = ".eINSTANCE.eClass();" + NL + "\t    \t";
  ...
  protected final String TEXT_102 = ")(registeredPackage instanceof ";
  protected final String TEXT_103 = " ? registeredPackage : ";
  protected final String TEXT_104 = ".eINSTANCE);";
  protected final String TEXT_105 = NL + "\t\t// Load packages";
  protected final String TEXT_106 = NL + "\t\tloadPackage();";
  protected final String TEXT_107 = ".loadPackage();";
  protected final String TEXT_108 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_109 = NL + "\t\tcreatePackageContents();";
  protected final String TEXT_110 = ".createPackageContents();";
  protected final String TEXT_111 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_112 = NL + "\t\tinitializePackageContents();";
  protected final String TEXT_113 = ".initializePackageContents();";
  protected final String TEXT_114 = NL + "\t\t// Fix loaded packages";
  protected final String TEXT_115 = NL + "\t\tfixPackageContents();";
  protected final String TEXT_116 = ".fixPackageContents();";
  protected final String TEXT_117 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_118 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
  protected final String TEXT_119 = "," + NL + "\t\t\t new ";
  protected final String TEXT_120 = ".Descriptor()" + NL + "\t\t\t {";
  protected final String TEXT_121 = NL + "\t\t\t\t @Override";
  protected final String TEXT_122 = NL + "\t\t\t\t public ";
  protected final String TEXT_123 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
  protected final String TEXT_124 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_125 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tfreeze();" + NL;
  protected final String TEXT_126 = NL + "\t\tsetEFactoryInstance(new ";
  protected final String TEXT_127 = "(this));" + NL + "\t\t// register the EPackageConfigurator" + NL + "\t\t";
  protected final String TEXT_128 = "<String, Object> properties = new ";
  protected final String TEXT_129 = "<String, Object>();" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NAME, ";
  protected final String TEXT_130 = ".eNAME);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NSURI, ";
  protected final String TEXT_131 = ".eNS_URI);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, \"";
  protected final String TEXT_132 = "\");";
  protected final String TEXT_133 = NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_CONTENT_TYPE, \"";
  protected final String TEXT_134 = NL + "\t\t" + NL + "\t\tePackageConfiguratorRegistration = ctx.registerService(";
  protected final String TEXT_135 = ".class, new ";
  protected final String TEXT_136 = "EPackageConfigurator(this), properties);" + NL + "\t}" + NL + "\t" + NL + "\t@";
  protected final String TEXT_137 = NL + "\tpublic void deactivate() {" + NL + "\t\tif(ePackageConfiguratorRegistration != null){" + NL + "\t\t\tePackageConfiguratorRegistration.unregister();" + NL + "\t\t}" + NL + "\t}";
  ...
  protected final String TEXT_154 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for class '<em>";
  ...
  protected final String TEXT_159 = NL + "\t * Returns the meta object for enum '{@link ";
  ...
  protected final String TEXT_165 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_166 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_167 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_168 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_174 = " == null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_175 = ")";
  protected final String TEXT_176 = ".eNS_URI).getEClassifiers().get(";
  ...
  protected final String TEXT_184 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_185 = " '<em>";
  protected final String TEXT_186 = NL + "\t * @see #get";
  protected final String TEXT_187 = NL + "\t\treturn (";
  protected final String TEXT_188 = ".getEStructuralFeatures().get(";
  ...
  protected final String TEXT_194 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_195 = "(";
  protected final String TEXT_196 = ") <em>";
  protected final String TEXT_197 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  ...
  protected final String TEXT_202 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_206 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_207 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_208 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  ...
  protected final String TEXT_218 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_219 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_220 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_221 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_222 = ".eNS_URI);" + NL + "      \t";
  protected final String TEXT_223 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_224 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_225 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_226 = "_";
  protected final String TEXT_227 = " = addETypeParameter(";
  ...
  protected final String TEXT_278 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  ...
  protected final String TEXT_299 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_300 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  ...
  protected final String TEXT_305 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_306 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_307 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_308 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_309 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_310 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_311 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_312 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_313 = ".\" + eClassifier.getName());";
  protected final String TEXT_314 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_315 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_316 = NL + "\t\t\t\tcase ";
  protected final String TEXT_317 = ":";
  protected final String TEXT_318 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_319 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_320 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_321 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_322 = " addEOperation(";
  protected final String TEXT_323 = " owner, ";
  protected final String TEXT_324 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_325 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_326 = " addEParameter(";
  protected final String TEXT_327 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_328 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_329 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_330 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_331 = "public ";
  protected final String TEXT_332 = "interface Literals" + NL + "\t{";
  protected final String TEXT_333 = NL + "\t\t/**";
  protected final String TEXT_334 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_335 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_336 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_337 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_338 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_339 = NL + "\t\t * @see ";
  protected final String TEXT_340 = NL + "\t\t * ";
  protected final String TEXT_341 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_342 = NL + "\t\t@Deprecated";
  protected final String TEXT_343 = " = eINSTANCE.get";
  protected final String TEXT_344 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_345 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_346 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
