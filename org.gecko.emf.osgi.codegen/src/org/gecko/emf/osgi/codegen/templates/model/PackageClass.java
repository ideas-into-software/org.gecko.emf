...
public class PackageClass
{
  ...
  protected final String TEXT_21 = NL + "@SuppressWarnings(\"deprecation\")" + NL + "@EMFModel(name=";
  protected final String TEXT_22 = ".eNAME, nsURI={";
  protected final String TEXT_23 = ".eNS_URI}, version=\"1.0.0\")" + NL + "// Only here for Backup Compatiblitly" + NL + "@ProvideEMFModel(name = ";
  ...
  protected final String TEXT_80 = NL + "\t// Reference required dependencies";
  protected final String TEXT_81 = NL + "\t@";
  protected final String TEXT_82 = NL + NL + "\tprivate ";
  protected final String TEXT_83 = "<";
  protected final String TEXT_84 = "> ePackageConfiguratorRegistration = null;" + NL + "\tprivate ";
  protected final String TEXT_85 = "<?> eFactoryRegistration = null;" + NL + "" + NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL + "\t * @see ";
  protected final String TEXT_86 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_87 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t}" + NL + "" + NL + "    /**" + NL + "\t * Activates and initializes the Package and registers the Package {@link org.gecko.emf.osgi.EPackageConfigurator}." + NL + "\t *" + NL + "     * @generated" + NL + "\t */" + NL + "    @";
  protected final String TEXT_88 = NL + "\tpublic void activate(";
  protected final String TEXT_89 = " ctx)" + NL + "\t{";
  ...
  protected final String TEXT_103 = NL + "\t\tloadPackage();";
  protected final String TEXT_104 = ".loadPackage();";
  protected final String TEXT_105 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_106 = NL + "\t\tcreatePackageContents();";
  protected final String TEXT_107 = ".createPackageContents();";
  protected final String TEXT_108 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_109 = NL + "\t\tinitializePackageContents();";
  protected final String TEXT_110 = ".initializePackageContents();";
  protected final String TEXT_111 = NL + "\t\t// Fix loaded packages";
  protected final String TEXT_112 = NL + "\t\tfixPackageContents();";
  protected final String TEXT_113 = ".fixPackageContents();";
  protected final String TEXT_114 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_115 = ".Registry.INSTANCE.put" + NL + "\t\t\t(this," + NL + "\t\t\t new ";
  ...
  protected final String TEXT_119 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_120 = "(";
  protected final String TEXT_121 = ".this);" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_122 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tfreeze();" + NL;
  protected final String TEXT_123 = NL + "\t\tsetEFactoryInstance(new ";
  protected final String TEXT_124 = "(this));" + NL + "" + NL + "\t\t// register the EPackageConfigurator" + NL + "\t\t";
  protected final String TEXT_125 = "<String, Object> properties = new ";
  protected final String TEXT_126 = "<String, Object>();" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NAME, ";
  protected final String TEXT_127 = ".eNAME);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NSURI, ";
  protected final String TEXT_128 = ".eNS_URI);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, \"";
  protected final String TEXT_129 = "\");";
  protected final String TEXT_130 = NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_CONTENT_TYPE, \"";
  protected final String TEXT_131 = NL + "\t\t" + NL + "\t\tePackageConfiguratorRegistration = ctx.registerService(";
  protected final String TEXT_132 = ".class, new ";
  protected final String TEXT_133 = "EPackageConfigurator(this), properties);" + NL + "\t\t" + NL + "\t\t//regsiter the EFactory as a service" + NL + "\t\teFactoryRegistration = ctx.registerService(new String[]{";
  protected final String TEXT_134 = ".class.getName(), ";
  protected final String TEXT_135 = ".class.getName()}, get";
  protected final String TEXT_136 = "(), properties);" + NL + "\t}" + NL + "\t" + NL + "\t@";
  protected final String TEXT_137 = NL + "\tpublic void deactivate() {" + NL + "\t\tif(ePackageConfiguratorRegistration != null){" + NL + "\t\t\tePackageConfiguratorRegistration.unregister();" + NL + "\t\t}" + NL + "\t\tif(eFactoryRegistration != null){" + NL + "\t\t\teFactoryRegistration.unregister();" + NL + "\t\t}" + NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_138 = ".Registry.INSTANCE.remove(this);" + NL + "\t}";
  protected final String TEXT_139 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_140 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_141 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_142 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_143 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_144 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_145 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_150 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_151 = ", EBasicWhiteList" + NL + "\t{";
  ...
  protected final String TEXT_163 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_164 = "</em>'.";
  protected final String TEXT_165 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_166 = "</em>}'.";
  protected final String TEXT_167 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_168 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_169 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_170 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_194 = "().getEStructuralFeatures().get(";
  protected final String TEXT_195 = "();";
  protected final String TEXT_196 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_197 = ") <em>";
  protected final String TEXT_198 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_199 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_200 = ".getEOperations().get(";
  protected final String TEXT_201 = NL + "        return get";
  protected final String TEXT_202 = "().getEOperations().get(";
  protected final String TEXT_203 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_206 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_207 = NL + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_208 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_209 = NL + "\tpublic void createPackageContents()" + NL + "\t{";
  protected final String TEXT_210 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_211 = " = create";
  protected final String TEXT_212 = NL + "\t\tcreate";
  protected final String TEXT_213 = ", ";
  protected final String TEXT_214 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_215 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_216 = " = createEEnum(";
  protected final String TEXT_217 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_218 = " = createEDataType(";
  protected final String TEXT_219 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_220 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_221 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_222 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_223 = ".eNS_URI);" + NL + "      \t";
  ...
  protected final String TEXT_230 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_231 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_232 = "g";
  protected final String TEXT_233 = " = createEGenericType(";
  protected final String TEXT_234 = NL + "\t\tg";
  protected final String TEXT_235 = ".";
  protected final String TEXT_236 = "(g";
  protected final String TEXT_237 = ".getEBounds().add(g1);";
  protected final String TEXT_238 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_239 = ".getESuperTypes().add(";
  protected final String TEXT_240 = ".get";
  protected final String TEXT_241 = "());";
  protected final String TEXT_242 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_243 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_244 = ", features, and operations; add parameters";
  protected final String TEXT_245 = " and features; add operations and parameters";
  protected final String TEXT_246 = NL + "\t\tinitEClass(";
  protected final String TEXT_247 = "null";
  protected final String TEXT_248 = ".class";
  protected final String TEXT_249 = "\", ";
  protected final String TEXT_250 = "\"";
  protected final String TEXT_251 = NL + "\t\tinitEReference(get";
  protected final String TEXT_252 = "(), ";
  protected final String TEXT_253 = "g1";
  protected final String TEXT_254 = NL + "\t\tget";
  protected final String TEXT_255 = "().getEKeys().add(";
  protected final String TEXT_256 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_257 = "initEOperation(get";
  protected final String TEXT_258 = "addEOperation(";
  protected final String TEXT_259 = "(), \"";
  protected final String TEXT_260 = ", null, \"";
  protected final String TEXT_261 = "addETypeParameter(op, \"";
  protected final String TEXT_262 = NL + "\t\tt";
  protected final String TEXT_263 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_264 = NL + "\t\taddEException(op, g";
  protected final String TEXT_265 = NL + "\t\taddEException(op, ";
  protected final String TEXT_266 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_267 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_268 = NL + "\t\tinitEEnum(";
  protected final String TEXT_269 = ".class, \"";
  protected final String TEXT_270 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_271 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_272 = NL + "\t\tinitEDataType(";
  protected final String TEXT_273 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_274 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_275 = NL + "\t\t// ";
  protected final String TEXT_276 = "Annotations();";
  protected final String TEXT_277 = NL + "\t}" + NL;
  protected final String TEXT_278 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_279 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_280 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_281 = "null;";
  protected final String TEXT_282 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_283 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_284 = NL + "\t\t\t   ";
  protected final String TEXT_285 = NL + "\t\t   }";
  protected final String TEXT_286 = ",";
  protected final String TEXT_287 = NL + "\t\t   new ";
  protected final String TEXT_288 = "[]" + NL + "\t\t   {";
  protected final String TEXT_289 = NL + "\t\t\t ";
  protected final String TEXT_290 = ".createURI(";
  protected final String TEXT_291 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_292 = "\")";
  protected final String TEXT_293 = NL + "\t\t   });";
  protected final String TEXT_294 = "," + NL + "\t\t   ";
  protected final String TEXT_295 = "new boolean[] { ";
  protected final String TEXT_296 = " }";
  protected final String TEXT_297 = "null,";
  protected final String TEXT_298 = "\",";
  protected final String TEXT_299 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_300 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_301 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_302 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_303 = " uri = ";
  protected final String TEXT_304 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_305 = " resource = new ";
  protected final String TEXT_306 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_307 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_308 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_309 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_310 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_311 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_312 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_313 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_314 = ".\" + eClassifier.getName());";
  protected final String TEXT_315 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_316 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_317 = NL + "\t\t\t\tcase ";
  protected final String TEXT_318 = ":";
  protected final String TEXT_319 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_320 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_321 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_322 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_323 = " addEOperation(";
  protected final String TEXT_324 = " owner, ";
  protected final String TEXT_325 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_326 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_327 = " addEParameter(";
  protected final String TEXT_328 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_329 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_330 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_331 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_332 = "public ";
  protected final String TEXT_333 = "interface Literals" + NL + "\t{";
  protected final String TEXT_334 = NL + "\t\t/**";
  protected final String TEXT_335 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_336 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_337 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_338 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_339 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_340 = NL + "\t\t * @see ";
  protected final String TEXT_341 = NL + "\t\t * ";
  protected final String TEXT_342 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_343 = NL + "\t\t@Deprecated";
  protected final String TEXT_344 = " = eINSTANCE.get";
  protected final String TEXT_345 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_346 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_347 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
 ...
 */
    ...
    Set<GenPackage> refPackages = new HashSet<>();
    for (GenPackage dep : genPackage.getPackageSimpleDependencies()) {
        if (Dependencies.isPureOSGi(dep)) {
            refPackages.add(dep);
        }
    }
    for (GenPackage dep : genPackage.getPackageInitializationDependencies()) {
        if (dep != genPackage && Dependencies.isPureOSGi(dep) && !refPackages.contains(dep)) {
            refPackages.add(dep);
        }
    } 
    stringBuffer.append(TEXT_7);
    if (!refPackages.isEmpty()) {
    stringBuffer.append(TEXT_80);
    for (GenPackage dep : refPackages) {
    ...
    if (interdep.isLiteralsInterface() || !interdep.getGenModel().isOSGiCompatible()) {
    ...
    if (interdep.isLoadingInitialization() && (interdep.isLiteralsInterface() || !interdep.getGenModel().isOSGiCompatible())) {
    stringBuffer.append(TEXT_91);
    stringBuffer.append(genPackage.getPackageInstanceVariable(interdep));
