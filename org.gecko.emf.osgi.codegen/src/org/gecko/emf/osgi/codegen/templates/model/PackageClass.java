...
public class PackageClass
{
  ...
  protected final String TEXT_36 = NL + NL + "\t/**" + NL + "\t * The package namespace name." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_37 = " eNS_PREFIX = \"";
  ...
  protected final String TEXT_62 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_63 = NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_64 = NL + "\t/**" + NL + "\t * The number of structural features of the '<em>";
  protected final String TEXT_65 = "</em>' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_66 = NL + "\t/**" + NL + "\t * The operation id for the '<em>";
  protected final String TEXT_67 = "</em>' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_68 = NL + "\t/**" + NL + "\t * The number of operations of the '<em>";
  protected final String TEXT_69 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected String packageFilename = \"";
  protected final String TEXT_70 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_71 = NL + "\tprivate ";
  ...
  protected final String TEXT_77 = ");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL + "\t *" + NL + "\t * <p>This method is used to initialize {@link ";
  protected final String TEXT_78 = "#eINSTANCE} when that field is accessed." + NL + "\t * Clients should not invoke it directly. Instead, they should simply access that field to obtain the package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
  ...
  protected final String TEXT_84 = ".eNS_URI);" + NL;
  protected final String TEXT_85 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_86 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject registered";
  protected final String TEXT_87 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_88 = " the";
  protected final String TEXT_89 = " = registered";
  protected final String TEXT_90 = " instanceof ";
  protected final String TEXT_91 = " ? (";
  protected final String TEXT_92 = ")registered";
  protected final String TEXT_93 = " : new ";
  protected final String TEXT_94 = "();" + NL + "" + NL + "\t\tisInited = true;" + NL;
  protected final String TEXT_95 = NL + "\t\t// Initialize simple dependencies";
  protected final String TEXT_96 = NL + "\t\t";
  protected final String TEXT_97 = ".eINSTANCE.eClass();";
  protected final String TEXT_98 = NL + "\t\t// Obtain or create and register interdependencies";
  protected final String TEXT_99 = "Object ";
  protected final String TEXT_100 = "registeredPackage = ";
  protected final String TEXT_101 = ".eNS_URI);" + NL + "\t\t";
  protected final String TEXT_102 = " = (";
  protected final String TEXT_103 = ")(registeredPackage instanceof ";
  protected final String TEXT_104 = " ? registeredPackage : ";
  protected final String TEXT_105 = ".eINSTANCE);";
  protected final String TEXT_106 = NL + "\t\t// Load packages";
  protected final String TEXT_107 = NL + "\t\tthe";
  protected final String TEXT_108 = ".loadPackage();";
  protected final String TEXT_109 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_110 = ".createPackageContents();";
  protected final String TEXT_111 = NL + NL + "\t\t// Initialize created meta-data";
  ...
  protected final String TEXT_123 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
  protected final String TEXT_124 = ".freeze();" + NL;
  protected final String TEXT_125 = NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_126 = ".Registry.INSTANCE.put(";
  protected final String TEXT_127 = ".eNS_URI, the";
  protected final String TEXT_128 = ");" + NL + "\t\treturn the";
  protected final String TEXT_129 = ";" + NL + "\t}";
  protected final String TEXT_130 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_131 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_132 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_133 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_134 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_135 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_136 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_141 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_142 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_143 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_144 = NL + "\t}";
  protected final String TEXT_145 = NL + "\t * Returns the meta object for class '{@link ";
  protected final String TEXT_146 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for class '<em>";
  protected final String TEXT_147 = "</em>'." + NL + "\t * @see ";
  protected final String TEXT_148 = NL + "\t * @model ";
  protected final String TEXT_149 = NL + "\t *        ";
  protected final String TEXT_150 = NL + "\t * @model";
  protected final String TEXT_151 = NL + "\t * Returns the meta object for enum '{@link ";
  ...
  protected final String TEXT_157 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_158 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_159 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_160 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_167 = ".eNS_URI).getEClassifiers().get(";
  protected final String TEXT_168 = ");" + NL + "\t\t}";
  protected final String TEXT_169 = NL + "\t\treturn ";
  protected final String TEXT_170 = ";" + NL + "\t}" + NL;
  protected final String TEXT_171 = "();" + NL;
  protected final String TEXT_172 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_173 = " '{@link ";
  protected final String TEXT_174 = "#";
  protected final String TEXT_175 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_176 = " '<em>";
  protected final String TEXT_177 = NL + "\t * @see #get";
  ...
  protected final String TEXT_183 = "().getEStructuralFeatures().get(";
  protected final String TEXT_184 = "();";
  protected final String TEXT_185 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_186 = "(";
  protected final String TEXT_187 = ") <em>";
  protected final String TEXT_188 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_189 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_190 = ".getEOperations().get(";
  protected final String TEXT_191 = NL + "        return get";
  protected final String TEXT_192 = "().getEOperations().get(";
  protected final String TEXT_193 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_194 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_195 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_196 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_197 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_198 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_199 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_200 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_201 = " = create";
  protected final String TEXT_202 = NL + "\t\tcreate";
  protected final String TEXT_203 = ", ";
  protected final String TEXT_204 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_205 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_206 = " = createEEnum(";
  protected final String TEXT_207 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_208 = " = createEDataType(";
  protected final String TEXT_209 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_210 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_211 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_212 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_213 = ".eNS_URI);";
  protected final String TEXT_214 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_215 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_216 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_217 = "_";
  protected final String TEXT_218 = " = addETypeParameter(";
  protected final String TEXT_219 = ", \"";
  protected final String TEXT_220 = "\");";
  protected final String TEXT_221 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_222 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_223 = "g";
  protected final String TEXT_224 = " = createEGenericType(";
  protected final String TEXT_225 = NL + "\t\tg";
  protected final String TEXT_226 = ".";
  protected final String TEXT_227 = "(g";
  protected final String TEXT_228 = ".getEBounds().add(g1);";
  protected final String TEXT_229 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_230 = ".getESuperTypes().add(";
  protected final String TEXT_231 = ".get";
  protected final String TEXT_232 = "());";
  protected final String TEXT_233 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_234 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_235 = ", features, and operations; add parameters";
  protected final String TEXT_236 = " and features; add operations and parameters";
  protected final String TEXT_237 = NL + "\t\tinitEClass(";
  protected final String TEXT_238 = "null";
  protected final String TEXT_239 = ".class";
  protected final String TEXT_240 = "\", ";
  protected final String TEXT_241 = "\"";
  protected final String TEXT_242 = NL + "\t\tinitEReference(get";
  protected final String TEXT_243 = "(), ";
  protected final String TEXT_244 = "g1";
  protected final String TEXT_245 = NL + "\t\tget";
  protected final String TEXT_246 = "().getEKeys().add(";
  protected final String TEXT_247 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_248 = "initEOperation(get";
  protected final String TEXT_249 = "addEOperation(";
  protected final String TEXT_250 = "(), \"";
  protected final String TEXT_251 = ", null, \"";
  protected final String TEXT_252 = "addETypeParameter(op, \"";
  protected final String TEXT_253 = NL + "\t\tt";
  protected final String TEXT_254 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_255 = NL + "\t\taddEException(op, g";
  protected final String TEXT_256 = NL + "\t\taddEException(op, ";
  protected final String TEXT_257 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_258 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_259 = NL + "\t\tinitEEnum(";
  protected final String TEXT_260 = ".class, \"";
  protected final String TEXT_261 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_262 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_263 = NL + "\t\tinitEDataType(";
  protected final String TEXT_264 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_265 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_266 = NL + "\t\t// ";
  protected final String TEXT_267 = "Annotations();";
  protected final String TEXT_268 = NL + "\t}" + NL;
  protected final String TEXT_269 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_270 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_271 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_272 = "null;";
  protected final String TEXT_273 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_274 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  ...
  protected final String TEXT_281 = ".createURI(";
  protected final String TEXT_282 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_283 = "\")";
  protected final String TEXT_284 = NL + "\t\t   });";
  protected final String TEXT_285 = "," + NL + "\t\t   ";
  protected final String TEXT_286 = "new boolean[] { ";
  protected final String TEXT_287 = " }";
  protected final String TEXT_288 = "null,";
  protected final String TEXT_289 = "\",";
  protected final String TEXT_290 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_291 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_292 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_293 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_294 = " uri = ";
  protected final String TEXT_295 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_296 = " resource = new ";
  protected final String TEXT_297 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_298 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_299 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_300 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_301 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_302 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_303 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_304 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_305 = ".\" + eClassifier.getName());";
  protected final String TEXT_306 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_307 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_308 = NL + "\t\t\t\tcase ";
  protected final String TEXT_309 = ":";
  protected final String TEXT_310 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_311 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_312 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_313 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_314 = " addEOperation(";
  protected final String TEXT_315 = " owner, ";
  protected final String TEXT_316 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_317 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_318 = " addEParameter(";
  protected final String TEXT_319 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_320 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_321 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_322 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_323 = "public ";
  protected final String TEXT_324 = "interface Literals" + NL + "\t{";
  protected final String TEXT_325 = NL + "\t\t/**";
  protected final String TEXT_326 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_327 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_328 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_329 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_330 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_331 = NL + "\t\t * @see ";
  protected final String TEXT_332 = NL + "\t\t * ";
  protected final String TEXT_333 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_334 = NL + "\t\t@Deprecated";
  protected final String TEXT_335 = " = eINSTANCE.get";
  protected final String TEXT_336 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_337 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_338 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
