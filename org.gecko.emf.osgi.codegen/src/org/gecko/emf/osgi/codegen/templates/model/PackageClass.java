...
public class PackageClass
{
  ...
  protected final String TEXT_39 = NL + NL + "\t/**" + NL + "\t * The package content type ID." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_40 = " eCONTENT_TYPE = \"";
  ...
  protected final String TEXT_55 = NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_63 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_64 = NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_65 = NL + "\t/**" + NL + "\t * The number of structural features of the '<em>";
  protected final String TEXT_66 = "</em>' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_67 = NL + "\t/**" + NL + "\t * The operation id for the '<em>";
  protected final String TEXT_68 = "</em>' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_69 = NL + "\t/**" + NL + "\t * The number of operations of the '<em>";
  protected final String TEXT_70 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected String packageFilename = \"";
  protected final String TEXT_71 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_72 = NL + "\tprivate ";
  ...
  protected final String TEXT_78 = ");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL + "\t *" + NL + "\t * <p>This method is used to initialize {@link ";
  ...
  protected final String TEXT_82 = " init()" + NL + "\t{" + NL + "\t\tif (isInited) return (";
  protected final String TEXT_83 = ")";
  protected final String TEXT_84 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_85 = ".eNS_URI);" + NL;
  protected final String TEXT_86 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_87 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject registered";
  protected final String TEXT_88 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_89 = " the";
  protected final String TEXT_90 = " = registered";
  protected final String TEXT_91 = " instanceof ";
  protected final String TEXT_92 = " ? (";
  protected final String TEXT_93 = ")registered";
  ...
  protected final String TEXT_99 = NL + "\t\t// Obtain or create and register interdependencies";
  ...
  protected final String TEXT_104 = ")(registeredPackage instanceof ";
  ...
  protected final String TEXT_110 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_111 = ".createPackageContents();";
  protected final String TEXT_112 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_113 = ".initializePackageContents();";
  protected final String TEXT_114 = NL + "\t\t// Fix loaded packages";
  ...
  protected final String TEXT_124 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
  protected final String TEXT_125 = ".freeze();" + NL;
  protected final String TEXT_126 = NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_127 = ".Registry.INSTANCE.put(";
  protected final String TEXT_128 = ".eNS_URI, the";
  protected final String TEXT_129 = ");" + NL + "\t\treturn the";
  protected final String TEXT_130 = ";" + NL + "\t}";
  protected final String TEXT_131 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_132 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_133 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_134 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_135 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_136 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_137 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_142 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_143 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_144 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_145 = NL + "\t}";
  protected final String TEXT_146 = NL + "\t * Returns the meta object for class '{@link ";
  ...
  protected final String TEXT_153 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  ...
  protected final String TEXT_158 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_159 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_160 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_161 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_168 = ".eNS_URI).getEClassifiers().get(";
  protected final String TEXT_169 = ");" + NL + "\t\t}";
  protected final String TEXT_170 = NL + "\t\treturn ";
  protected final String TEXT_171 = ";" + NL + "\t}" + NL;
  protected final String TEXT_172 = "();" + NL;
  protected final String TEXT_173 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_174 = " '{@link ";
  protected final String TEXT_175 = "#";
  protected final String TEXT_176 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_177 = " '<em>";
  protected final String TEXT_178 = NL + "\t * @see #get";
  ...
  protected final String TEXT_184 = "().getEStructuralFeatures().get(";
  protected final String TEXT_185 = "();";
  protected final String TEXT_186 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_187 = "(";
  protected final String TEXT_188 = ") <em>";
  protected final String TEXT_189 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_190 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_191 = ".getEOperations().get(";
  protected final String TEXT_192 = NL + "        return get";
  protected final String TEXT_193 = "().getEOperations().get(";
  protected final String TEXT_194 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_195 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_196 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_197 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_198 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_199 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_200 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_201 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_202 = " = create";
  protected final String TEXT_203 = NL + "\t\tcreate";
  protected final String TEXT_204 = ", ";
  protected final String TEXT_205 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_206 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_207 = " = createEEnum(";
  protected final String TEXT_208 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_209 = " = createEDataType(";
  protected final String TEXT_210 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_211 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_212 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_213 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_214 = ".eNS_URI);";
  protected final String TEXT_215 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_216 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_217 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_218 = "_";
  protected final String TEXT_219 = " = addETypeParameter(";
  protected final String TEXT_220 = ", \"";
  protected final String TEXT_221 = "\");";
  protected final String TEXT_222 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_223 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_224 = "g";
  protected final String TEXT_225 = " = createEGenericType(";
  protected final String TEXT_226 = NL + "\t\tg";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = "(g";
  protected final String TEXT_229 = ".getEBounds().add(g1);";
  protected final String TEXT_230 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_231 = ".getESuperTypes().add(";
  protected final String TEXT_232 = ".get";
  protected final String TEXT_233 = "());";
  protected final String TEXT_234 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_235 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_236 = ", features, and operations; add parameters";
  protected final String TEXT_237 = " and features; add operations and parameters";
  protected final String TEXT_238 = NL + "\t\tinitEClass(";
  protected final String TEXT_239 = "null";
  protected final String TEXT_240 = ".class";
  protected final String TEXT_241 = "\", ";
  protected final String TEXT_242 = "\"";
  protected final String TEXT_243 = NL + "\t\tinitEReference(get";
  protected final String TEXT_244 = "(), ";
  protected final String TEXT_245 = "g1";
  protected final String TEXT_246 = NL + "\t\tget";
  protected final String TEXT_247 = "().getEKeys().add(";
  protected final String TEXT_248 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_249 = "initEOperation(get";
  protected final String TEXT_250 = "addEOperation(";
  protected final String TEXT_251 = "(), \"";
  protected final String TEXT_252 = ", null, \"";
  protected final String TEXT_253 = "addETypeParameter(op, \"";
  protected final String TEXT_254 = NL + "\t\tt";
  protected final String TEXT_255 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_256 = NL + "\t\taddEException(op, g";
  protected final String TEXT_257 = NL + "\t\taddEException(op, ";
  protected final String TEXT_258 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_259 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_260 = NL + "\t\tinitEEnum(";
  protected final String TEXT_261 = ".class, \"";
  protected final String TEXT_262 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_263 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_264 = NL + "\t\tinitEDataType(";
  protected final String TEXT_265 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_266 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_267 = NL + "\t\t// ";
  protected final String TEXT_268 = "Annotations();";
  protected final String TEXT_269 = NL + "\t}" + NL;
  protected final String TEXT_270 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_271 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_272 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_273 = "null;";
  protected final String TEXT_274 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_275 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_276 = NL + "\t\t\t   ";
  protected final String TEXT_277 = NL + "\t\t   }";
  protected final String TEXT_278 = ",";
  protected final String TEXT_279 = NL + "\t\t   new ";
  protected final String TEXT_280 = "[]" + NL + "\t\t   {";
  protected final String TEXT_281 = NL + "\t\t\t ";
  protected final String TEXT_282 = ".createURI(";
  protected final String TEXT_283 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_284 = "\")";
  protected final String TEXT_285 = NL + "\t\t   });";
  protected final String TEXT_286 = "," + NL + "\t\t   ";
  protected final String TEXT_287 = "new boolean[] { ";
  protected final String TEXT_288 = " }";
  protected final String TEXT_289 = "null,";
  protected final String TEXT_290 = "\",";
  protected final String TEXT_291 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_292 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_293 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_294 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_295 = " uri = ";
  protected final String TEXT_296 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_297 = " resource = new ";
  protected final String TEXT_298 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_299 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_300 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_301 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_302 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_303 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_304 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_305 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_306 = ".\" + eClassifier.getName());";
  protected final String TEXT_307 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_308 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_309 = NL + "\t\t\t\tcase ";
  protected final String TEXT_310 = ":";
  protected final String TEXT_311 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_312 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_313 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_314 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_315 = " addEOperation(";
  protected final String TEXT_316 = " owner, ";
  protected final String TEXT_317 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_318 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_319 = " addEParameter(";
  protected final String TEXT_320 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_321 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_322 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_323 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_324 = "public ";
  protected final String TEXT_325 = "interface Literals" + NL + "\t{";
  protected final String TEXT_326 = NL + "\t\t/**";
  protected final String TEXT_327 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_328 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_329 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_330 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_331 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  ...
  protected final String TEXT_337 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_338 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_339 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
 ...
 */
    ...
    if(props.containsKey(GeckoEmfGenerator.ORIGINAL_GEN_MODEL_PATHS)){
    	List<String> paths = (List<String>) props.get(GeckoEmfGenerator.ORIGINAL_GEN_MODEL_PATHS);
