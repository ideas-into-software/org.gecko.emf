...
public class PackageClass
{
  ...
  protected final String TEXT_29 = ".class }, immediate = true)" + NL + "public class ";
  protected final String TEXT_30 = " extends ";
  protected final String TEXT_31 = " implements ";
  ...
  protected final String TEXT_36 = NL + "\t/**" + NL + "\t * The package name." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_37 = " eNAME = \"";
  protected final String TEXT_38 = "\";";
  protected final String TEXT_39 = NL + NL + "\t/**" + NL + "\t * The package namespace URI." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_40 = " eNS_URI = \"";
  ...
  protected final String TEXT_45 = NL + "\t/**" + NL + "\t * The singleton instance of the package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_46 = " eINSTANCE = ";
  protected final String TEXT_47 = ".init();";
  ...
  protected final String TEXT_70 = "</em>' class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_71 = NL + "\t/**" + NL + "\t * The operation id for the '<em>";
  protected final String TEXT_72 = "</em>' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_73 = NL + "\t/**" + NL + "\t * The number of operations of the '<em>";
  protected final String TEXT_74 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected String packageFilename = \"";
  protected final String TEXT_75 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_76 = NL + "\tprivate ";
  protected final String TEXT_77 = " ";
  protected final String TEXT_78 = " = null;" + NL;
  protected final String TEXT_79 = NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL + "\t * @see ";
  protected final String TEXT_80 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate ";
  protected final String TEXT_81 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t}" + NL;
  protected final String TEXT_82 = NL + "\t// Reference the imported Models" + NL + "\t";
  protected final String TEXT_83 = NL + "\t\t";
  protected final String TEXT_84 = NL + "\t@";
  protected final String TEXT_85 = " the";
  protected final String TEXT_86 = "; " + NL + "\t    ";
  protected final String TEXT_87 = NL + NL + "\tprivate ";
  protected final String TEXT_88 = "<";
  protected final String TEXT_89 = "EPackageConfigurator> ePackageConfiguratorRegistration = null;" + NL + "" + NL + "    /**" + NL + "\t * Activates and initializes the Package and registers the Package {@link org.gecko.emf.osgi.EPackageConfigurator}." + NL + "\t *" + NL + "     * @generated" + NL + "\t */" + NL + "    @";
  protected final String TEXT_90 = NL + "  \tpublic void activate(";
  protected final String TEXT_91 = " ctx)" + NL + "  \t{" + NL + "  \t    ";
  protected final String TEXT_92 = NL + "\t\t// Initialize simple dependencies" + NL + "\t    ";
  protected final String TEXT_93 = ".eINSTANCE.eClass();" + NL + "\t    \t";
  ...
  protected final String TEXT_97 = ".Registry.INSTANCE.getEPackage(";
  ...
  protected final String TEXT_104 = NL + "\t\tloadPackage();";
  protected final String TEXT_105 = ".loadPackage();";
  protected final String TEXT_106 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_107 = NL + "\t\tcreatePackageContents();";
  protected final String TEXT_108 = ".createPackageContents();";
  protected final String TEXT_109 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_110 = NL + "\t\tinitializePackageContents();";
  protected final String TEXT_111 = ".initializePackageContents();";
  protected final String TEXT_112 = NL + "\t\t// Fix loaded packages";
  protected final String TEXT_113 = NL + "\t\tfixPackageContents();";
  protected final String TEXT_114 = ".fixPackageContents();";
  protected final String TEXT_115 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_116 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
  protected final String TEXT_117 = "," + NL + "\t\t\t new ";
  protected final String TEXT_118 = ".Descriptor()" + NL + "\t\t\t {";
  protected final String TEXT_119 = NL + "\t\t\t\t @Override";
  protected final String TEXT_120 = NL + "\t\t\t\t public ";
  protected final String TEXT_121 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
  protected final String TEXT_122 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_123 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tfreeze();" + NL;
  protected final String TEXT_124 = NL + "\t\tsetEFactoryInstance(new ";
  protected final String TEXT_125 = "(this));" + NL + "\t\t// register the EPackageConfigurator" + NL + "\t\t";
  protected final String TEXT_126 = "<String, Object> properties = new ";
  protected final String TEXT_127 = "<String, Object>();" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NAME, ";
  protected final String TEXT_128 = ".eNAME);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_NSURI, ";
  protected final String TEXT_129 = ".eNS_URI);" + NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, \"";
  protected final String TEXT_130 = "\");";
  protected final String TEXT_131 = NL + "\t\tproperties.put(EMFNamespaces.EMF_MODEL_CONTENT_TYPE, \"";
  protected final String TEXT_132 = NL + "\t\t" + NL + "\t\tePackageConfiguratorRegistration = ctx.registerService(";
  protected final String TEXT_133 = "EPackageConfigurator.class, new ";
  protected final String TEXT_134 = "EPackageConfigurator(this), properties);" + NL + "\t}" + NL + "\t" + NL + "\t@";
  protected final String TEXT_135 = NL + "\tpublic void deactivate() {" + NL + "\t\tif(ePackageConfiguratorRegistration != null){" + NL + "\t\t\tePackageConfiguratorRegistration.unregister();" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_136 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_137 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_138 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_139 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_140 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_141 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_142 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_147 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_148 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_149 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  ...
  protected final String TEXT_158 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  ...
  protected final String TEXT_163 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_164 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_165 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_166 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_179 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_180 = " '{@link ";
  protected final String TEXT_181 = "#";
  protected final String TEXT_182 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_183 = " '<em>";
  protected final String TEXT_184 = NL + "\t * @see #get";
  ...
  protected final String TEXT_192 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_193 = "(";
  protected final String TEXT_194 = ") <em>";
  protected final String TEXT_195 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_196 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_197 = ".getEOperations().get(";
  protected final String TEXT_198 = NL + "        return get";
  protected final String TEXT_199 = "().getEOperations().get(";
  protected final String TEXT_200 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_203 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_204 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_205 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_206 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_207 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_208 = " = create";
  protected final String TEXT_209 = NL + "\t\tcreate";
  protected final String TEXT_210 = ", ";
  protected final String TEXT_211 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_212 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_213 = " = createEEnum(";
  protected final String TEXT_214 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_215 = " = createEDataType(";
  protected final String TEXT_216 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_217 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_218 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_219 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_220 = ".eNS_URI);" + NL + "      \t";
  protected final String TEXT_221 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_222 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_223 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_224 = "_";
  protected final String TEXT_225 = " = addETypeParameter(";
  protected final String TEXT_226 = ", \"";
  protected final String TEXT_227 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_228 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_229 = "g";
  protected final String TEXT_230 = " = createEGenericType(";
  protected final String TEXT_231 = NL + "\t\tg";
  protected final String TEXT_232 = ".";
  protected final String TEXT_233 = "(g";
  protected final String TEXT_234 = ".getEBounds().add(g1);";
  protected final String TEXT_235 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_236 = ".getESuperTypes().add(";
  protected final String TEXT_237 = ".get";
  protected final String TEXT_238 = "());";
  protected final String TEXT_239 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_240 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_241 = ", features, and operations; add parameters";
  protected final String TEXT_242 = " and features; add operations and parameters";
  protected final String TEXT_243 = NL + "\t\tinitEClass(";
  protected final String TEXT_244 = "null";
  protected final String TEXT_245 = ".class";
  protected final String TEXT_246 = "\", ";
  protected final String TEXT_247 = "\"";
  protected final String TEXT_248 = NL + "\t\tinitEReference(get";
  protected final String TEXT_249 = "(), ";
  protected final String TEXT_250 = "g1";
  protected final String TEXT_251 = NL + "\t\tget";
  protected final String TEXT_252 = "().getEKeys().add(";
  protected final String TEXT_253 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_254 = "initEOperation(get";
  protected final String TEXT_255 = "addEOperation(";
  protected final String TEXT_256 = "(), \"";
  protected final String TEXT_257 = ", null, \"";
  protected final String TEXT_258 = "addETypeParameter(op, \"";
  protected final String TEXT_259 = NL + "\t\tt";
  protected final String TEXT_260 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_261 = NL + "\t\taddEException(op, g";
  protected final String TEXT_262 = NL + "\t\taddEException(op, ";
  protected final String TEXT_263 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_264 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_265 = NL + "\t\tinitEEnum(";
  protected final String TEXT_266 = ".class, \"";
  protected final String TEXT_267 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_268 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_269 = NL + "\t\tinitEDataType(";
  protected final String TEXT_270 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_271 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_272 = NL + "\t\t// ";
  protected final String TEXT_273 = "Annotations();";
  protected final String TEXT_274 = NL + "\t}" + NL;
  protected final String TEXT_275 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_276 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_277 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_278 = "null;";
  protected final String TEXT_279 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_280 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_281 = NL + "\t\t\t   ";
  protected final String TEXT_282 = NL + "\t\t   }";
  protected final String TEXT_283 = ",";
  protected final String TEXT_284 = NL + "\t\t   new ";
  protected final String TEXT_285 = "[]" + NL + "\t\t   {";
  protected final String TEXT_286 = NL + "\t\t\t ";
  protected final String TEXT_287 = ".createURI(";
  protected final String TEXT_288 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_289 = "\")";
  protected final String TEXT_290 = NL + "\t\t   });";
  protected final String TEXT_291 = "," + NL + "\t\t   ";
  protected final String TEXT_292 = "new boolean[] { ";
  protected final String TEXT_293 = " }";
  protected final String TEXT_294 = "null,";
  protected final String TEXT_295 = "\",";
  protected final String TEXT_296 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_297 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_298 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_299 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_300 = " uri = ";
  protected final String TEXT_301 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_302 = " resource = new ";
  protected final String TEXT_303 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_304 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_305 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_306 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_307 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_308 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_309 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_310 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_311 = ".\" + eClassifier.getName());";
  protected final String TEXT_312 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_313 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_314 = NL + "\t\t\t\tcase ";
  protected final String TEXT_315 = ":";
  protected final String TEXT_316 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_317 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_318 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_319 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_320 = " addEOperation(";
  protected final String TEXT_321 = " owner, ";
  protected final String TEXT_322 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_323 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_324 = " addEParameter(";
  protected final String TEXT_325 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_326 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_327 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_328 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_329 = "public ";
  protected final String TEXT_330 = "interface Literals" + NL + "\t{";
  protected final String TEXT_331 = NL + "\t\t/**";
  protected final String TEXT_332 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_333 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_334 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_335 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_336 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_337 = NL + "\t\t * @see ";
  protected final String TEXT_338 = NL + "\t\t * ";
  protected final String TEXT_339 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_340 = NL + "\t\t@Deprecated";
  protected final String TEXT_341 = " = eINSTANCE.get";
  protected final String TEXT_342 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_343 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_344 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
