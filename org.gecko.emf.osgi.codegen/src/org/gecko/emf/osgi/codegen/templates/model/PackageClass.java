...
public class PackageClass
{
  ...
  protected final String TEXT_86 = "> ePackageConfiguratorRegistration = null;" + NL + "" + NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL + "\t * @see ";
  protected final String TEXT_87 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_88 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t}" + NL + "" + NL + "    /**" + NL + "\t * Activates and initializes the Package and registers the Package {@link org.gecko.emf.osgi.EPackageConfigurator}." + NL + "\t *" + NL + "     * @generated" + NL + "\t */" + NL + "    @";
  protected final String TEXT_89 = NL + "\tpublic void activate(";
  protected final String TEXT_90 = " ctx)" + NL + "\t{";
  ...
  protected final String TEXT_133 = ".class, new ";
  ...
  protected final String TEXT_152 = NL + "\t * Returns the meta object for class '{@link ";
  ...
  protected final String TEXT_160 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_161 = "</em>'.";
  protected final String TEXT_162 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_163 = "</em>}'.";
  protected final String TEXT_164 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_165 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_166 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_167 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_180 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_181 = " '{@link ";
  protected final String TEXT_182 = "#";
  protected final String TEXT_183 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_184 = " '<em>";
  protected final String TEXT_185 = NL + "\t * @see #get";
  protected final String TEXT_186 = NL + "\t\treturn (";
  protected final String TEXT_187 = ".getEStructuralFeatures().get(";
  ...
  protected final String TEXT_193 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_194 = "(";
  protected final String TEXT_195 = ") <em>";
  protected final String TEXT_196 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_197 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_198 = ".getEOperations().get(";
  protected final String TEXT_199 = NL + "        return get";
  protected final String TEXT_200 = "().getEOperations().get(";
  protected final String TEXT_201 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_202 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_203 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_204 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_205 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_206 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_207 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_208 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_209 = " = create";
  protected final String TEXT_210 = NL + "\t\tcreate";
  protected final String TEXT_211 = ", ";
  protected final String TEXT_212 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_213 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_214 = " = createEEnum(";
  protected final String TEXT_215 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_216 = " = createEDataType(";
  protected final String TEXT_217 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_218 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_219 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_220 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_221 = ".eNS_URI);" + NL + "      \t";
  ...
  protected final String TEXT_228 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_229 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_230 = "g";
  protected final String TEXT_231 = " = createEGenericType(";
  protected final String TEXT_232 = NL + "\t\tg";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = "(g";
  protected final String TEXT_235 = ".getEBounds().add(g1);";
  protected final String TEXT_236 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_237 = ".getESuperTypes().add(";
  protected final String TEXT_238 = ".get";
  protected final String TEXT_239 = "());";
  protected final String TEXT_240 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_241 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_242 = ", features, and operations; add parameters";
  protected final String TEXT_243 = " and features; add operations and parameters";
  protected final String TEXT_244 = NL + "\t\tinitEClass(";
  protected final String TEXT_245 = "null";
  protected final String TEXT_246 = ".class";
  protected final String TEXT_247 = "\", ";
  protected final String TEXT_248 = "\"";
  protected final String TEXT_249 = NL + "\t\tinitEReference(get";
  protected final String TEXT_250 = "(), ";
  protected final String TEXT_251 = "g1";
  protected final String TEXT_252 = NL + "\t\tget";
  protected final String TEXT_253 = "().getEKeys().add(";
  protected final String TEXT_254 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_255 = "initEOperation(get";
  protected final String TEXT_256 = "addEOperation(";
  protected final String TEXT_257 = "(), \"";
  protected final String TEXT_258 = ", null, \"";
  protected final String TEXT_259 = "addETypeParameter(op, \"";
  protected final String TEXT_260 = NL + "\t\tt";
  protected final String TEXT_261 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_262 = NL + "\t\taddEException(op, g";
  protected final String TEXT_263 = NL + "\t\taddEException(op, ";
  protected final String TEXT_264 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_265 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_266 = NL + "\t\tinitEEnum(";
  protected final String TEXT_267 = ".class, \"";
  protected final String TEXT_268 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_269 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_270 = NL + "\t\tinitEDataType(";
  protected final String TEXT_271 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_272 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_273 = NL + "\t\t// ";
  protected final String TEXT_274 = "Annotations();";
  protected final String TEXT_275 = NL + "\t}" + NL;
  protected final String TEXT_276 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_277 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_278 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_279 = "null;";
  protected final String TEXT_280 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_281 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  ...
  protected final String TEXT_288 = ".createURI(";
  protected final String TEXT_289 = "eNS_URI).appendFragment(\"";
  ...
  protected final String TEXT_297 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_298 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_299 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_300 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_301 = " uri = ";
  protected final String TEXT_302 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_303 = " resource = new ";
  protected final String TEXT_304 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_305 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_306 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_307 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_308 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_309 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_310 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_311 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_312 = ".\" + eClassifier.getName());";
  protected final String TEXT_313 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_314 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_315 = NL + "\t\t\t\tcase ";
  protected final String TEXT_316 = ":";
  protected final String TEXT_317 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_318 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_319 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_320 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_321 = " addEOperation(";
  protected final String TEXT_322 = " owner, ";
  protected final String TEXT_323 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_324 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_325 = " addEParameter(";
  protected final String TEXT_326 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_327 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_328 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_329 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_330 = "public ";
  protected final String TEXT_331 = "interface Literals" + NL + "\t{";
  protected final String TEXT_332 = NL + "\t\t/**";
  protected final String TEXT_333 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_334 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_335 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_336 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_337 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_338 = NL + "\t\t * @see ";
  protected final String TEXT_339 = NL + "\t\t * ";
  protected final String TEXT_340 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_341 = NL + "\t\t@Deprecated";
  protected final String TEXT_342 = " = eINSTANCE.get";
  protected final String TEXT_343 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_344 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_345 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
