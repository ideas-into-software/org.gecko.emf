...
public class MongoIntegrationTest extends MongoEMFSetting {
	...
	public void testEMFMongo() throws BundleException, InvalidSyntaxException, IOException, InterruptedException {
		...
		filter = "(&(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=mongo)(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=" + dbAlias + ")(objectClass=org.geckoprojects.emf.core.ResourceSetFactory))";
	...
	public void testEMFMongoMany() throws BundleException, InvalidSyntaxException, IOException, InterruptedException {
		...
		String filter = "(&(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=mongo)(objectClass=org.geckoprojects.emf.core.ResourceSetConfigurator)(" + MongoResourceSetConfiguratorComponent.PROP_MONGO_ALIAS + "=" + dbAlias1 + "))";
		ResourceSetConfigurator rsc = (ResourceSetConfigurator) createTrackedChecker(filter, true)
				.assertCreations(1, true)
				.trackedServiceNotNull()
				.getTrackedService();
		...
		filter = "(&(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=mongo)(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=testDB)(objectClass=org.geckoprojects.emf.core.ResourceSetFactory))";
		createTrackedChecker(filter, true)
			.assertCreations(1, true)
			.trackedServiceNotNull();
		
		filter = "(&(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=mongo)(" + EMFNamespaces.EMF_CONFIGURATOR_NAME + "=test.myDB)(objectClass=org.geckoprojects.emf.core.ResourceSetFactory))";
	 ...
	 */
	@Test
	public void testCreateAndRemoveSingle() throws BundleException, InvalidSyntaxException, IOException, InterruptedException {
