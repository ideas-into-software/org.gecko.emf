...
public class WorkerQueue implements Runnable {
	...
	private static Logger LOGGER = Logger.getLogger(WorkerQueue.class.getName());
        ...
        synchronized ( this.tasks ) {
            if ( !this.stopped ) {
                ...
                if ( this.backgroundThread == null ) {
                    ...
                    this.backgroundThread.setName("Gecko EMF Model Extender Worker Thread");
        ...
        do {
            ...
            if ( r != null ) {
                try {
                	...
                	LOGGER.log(Level.SEVERE, t, ()->"Error processing task" + t.getMessage());
                }
            }
        } while ( r != null );
    }
