...
public class QueryPackageImpl extends EPackageImpl implements QueryPackage {
	 ...
	 * @see org.geckoprojects.utilities.query.QueryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getQuery_Active() {
	 ...
	 * @generated
	 */
	public EAttribute getQueryCondition_Id() {
	...
	public void createPackageContents() {
		...
		createEReference(queryEClass, QUERY__CONDITION);
		...
		createEAttribute(queryEClass, QUERY__ACTIVE);

		queryConditionEClass = createEClass(QUERY_CONDITION);
		createEAttribute(queryConditionEClass, QUERY_CONDITION__ID);

		// Create enums
		logicalOperatorEEnum = createEEnum(LOGICAL_OPERATOR);
		isnotEEnum = createEEnum(ISNOT);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getQuery_Condition(), this.getQueryCondition(), null, "condition", null, 0, 1, Query.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getQuery_Id(), ecorePackage.getEString(), "id", null, 0, 1, Query.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQuery_Active(), ecorePackage.getEBoolean(), "active", null, 0, 1, Query.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(queryConditionEClass, QueryCondition.class, "QueryCondition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getQueryCondition_Id(), ecorePackage.getEString(), "id", null, 0, 1, QueryCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(isnotEEnum, org.geckoprojects.utilities.query.ISNOT.class, "ISNOT");
		addEEnumLiteral(isnotEEnum, org.geckoprojects.utilities.query.ISNOT.IS);
		addEEnumLiteral(isnotEEnum, org.geckoprojects.utilities.query.ISNOT.NOT);
