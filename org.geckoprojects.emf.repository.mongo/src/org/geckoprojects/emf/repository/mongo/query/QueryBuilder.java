...
public class QueryBuilder {
    ...
    public QueryBuilder greaterThan(final Object object) {
        addOperand(MongoQueryOperators.GT, object);
        return this;
    }
    ...
    public QueryBuilder greaterThanEquals(final Object object) {
        addOperand(MongoQueryOperators.GTE, object);
        return this;
    }
    ...
    public QueryBuilder lessThan(final Object object) {
        addOperand(MongoQueryOperators.LT, object);
        return this;
    }
    ...
    public QueryBuilder lessThanEquals(final Object object) {
        addOperand(MongoQueryOperators.LTE, object);
        return this;
    }
    ...
    public QueryBuilder notEquals(final Object object) {
        addOperand(MongoQueryOperators.NE, object);
        return this;
    }
    ...
    public QueryBuilder in(final Object object) {
        addOperand(MongoQueryOperators.IN, object);
        return this;
    }
    ...
    public QueryBuilder notIn(final Object object) {
        addOperand(MongoQueryOperators.NIN, object);
        return this;
    }
    ...
    public QueryBuilder mod(final Object object) {
        addOperand(MongoQueryOperators.MOD, object);
        return this;
    }
    ...
    public QueryBuilder all(final Object object) {
        addOperand(MongoQueryOperators.ALL, object);
        return this;
    }
    ...
    public QueryBuilder size(final Object object) {
        addOperand(MongoQueryOperators.SIZE, object);
        return this;
    }
    ...
    public QueryBuilder exists(final Object object) {
        addOperand(MongoQueryOperators.EXISTS, object);
        return this;
    }
    ...
    public QueryBuilder elemMatch(final DBObject match) {
        addOperand(MongoQueryOperators.ELEM_MATCH, match);
        return this;
    }
    ...
    public QueryBuilder withinCenter(final double x, final double y, final double radius) {
        addOperand(MongoQueryOperators.WITHIN,
                   new BasicDBObject(MongoQueryOperators.CENTER, asList(asList(x, y), radius)));
        return this;
    }
    ...
    public QueryBuilder near(final double x, final double y) {
        addOperand(MongoQueryOperators.NEAR,
                   asList(x, y));
        return this;
    }
    ...
    public QueryBuilder near(final double x, final double y, final double maxDistance) {
        addOperand(MongoQueryOperators.NEAR,
                   asList(x, y));
        addOperand(MongoQueryOperators.MAX_DISTANCE,
                   maxDistance);
        return this;
    }
    ...
    public QueryBuilder nearSphere(final double longitude, final double latitude) {
        addOperand(MongoQueryOperators.NEAR_SPHERE,
    ...
    public QueryBuilder withinCenterSphere(final double longitude, final double latitude, final double maxDistance) {
        addOperand(MongoQueryOperators.WITHIN,
                   new BasicDBObject(MongoQueryOperators.CENTER_SPHERE,
    ...
    public QueryBuilder withinBox(final double x, final double y, final double x2, final double y2) {
        addOperand(MongoQueryOperators.WITHIN,
                   new BasicDBObject(MongoQueryOperators.BOX, new Object[]{new Double[]{x, y}, new Double[]{x2, y2}}));
        return this;
    }
    ...
    public QueryBuilder withinPolygon(final List<Double[]> points) {
        ...
        addOperand(MongoQueryOperators.WITHIN,
                   new BasicDBObject(MongoQueryOperators.POLYGON, convertToListOfLists(points)));
        return this;
    }
    ...
    public QueryBuilder text(final String search, @Nullable final String language) {
        ...
        put(MongoQueryOperators.TEXT);
        addOperand(MongoQueryOperators.SEARCH, search);
        if (language != null) {
            addOperand(MongoQueryOperators.LANGUAGE, language);
        }
    ...
    public QueryBuilder or(final DBObject... ors) {
        List l = (List) _query.get(MongoQueryOperators.OR);
        if (l == null) {
            l = new ArrayList();
            _query.put(MongoQueryOperators.OR, l);
        }
    ...
    public QueryBuilder and(final DBObject... ands) {
        List l = (List) _query.get(MongoQueryOperators.AND);
        if (l == null) {
            l = new ArrayList();
            _query.put(MongoQueryOperators.AND, l);
        }
    ...
    private void addOperand(@Nullable final String op, final Object value) {
        ...
        if (op == null) {
            if (_hasNot) {
                valueToPut = new BasicDBObject(MongoQueryOperators.NOT, valueToPut);
                _hasNot = false;
            }
        ...
        if (!(storedValue instanceof DBObject)) {
            ...
            if (_hasNot) {
                DBObject notOperand = new BasicDBObject(MongoQueryOperators.NOT, operand);
            ...
            if (operand.get(MongoQueryOperators.NOT) != null) {
                operand = (BasicDBObject) operand.get(MongoQueryOperators.NOT);
            }
        }
