 ...
 * </p>
 * <ul>
 *   <li>{@link org.geckoprojects.emf.utilities.impl.ResponseImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link org.geckoprojects.emf.utilities.impl.ResponseImpl#getResultSize <em>Result Size</em>}</li>
 *   <li>{@link org.geckoprojects.emf.utilities.impl.ResponseImpl#getResponseCode <em>Response Code</em>}</li>
 *   <li>{@link org.geckoprojects.emf.utilities.impl.ResponseImpl#getResponseMessage <em>Response Message</em>}</li>
 *   <li>{@link org.geckoprojects.emf.utilities.impl.ResponseImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseImpl extends MinimalEObjectImpl.Container implements Response {
	...
	public void setTimestamp(Date newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.RESPONSE__TIMESTAMP, oldTimestamp, timestamp));
	}
	...
	public void setResultSize(int newResultSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.RESPONSE__RESULT_SIZE, oldResultSize, resultSize));
	}
	...
	public void setResponseCode(String newResponseCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.RESPONSE__RESPONSE_CODE, oldResponseCode, responseCode));
	}
	...
	public void setResponseMessage(String newResponseMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UtilPackage.RESPONSE__RESPONSE_MESSAGE, oldResponseMessage, responseMessage));
	}
	...
	public EList<EObject> getData() {
		if (data == null) {
			data = new EObjectContainmentEList<EObject>(EObject.class, this, UtilPackage.RESPONSE__DATA);
		}
		return data;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UtilPackage.RESPONSE__DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UtilPackage.RESPONSE__TIMESTAMP:
				return getTimestamp();
			case UtilPackage.RESPONSE__RESULT_SIZE:
				return getResultSize();
			case UtilPackage.RESPONSE__RESPONSE_CODE:
				return getResponseCode();
			case UtilPackage.RESPONSE__RESPONSE_MESSAGE:
