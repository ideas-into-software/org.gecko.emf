...
public class ExtendedPrefixSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtendedPrefixPackage.EXTENDED_ADDRESS: {
			...
			case ExtendedPrefixPackage.EXTENDED_PERSON: {
				ExtendedPerson extendedPerson = (ExtendedPerson)theEObject;
				T result = caseExtendedPerson(extendedPerson);
				if (result == null) result = caseEmployeeInfo(extendedPerson);
				if (result == null) result = casePerson(extendedPerson);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extended Person</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extended Person</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtendedPerson(ExtendedPerson object) {
		return null;
	}
