...
//		ManualPackageConfigurator testPackageConfigurator = new ManualPackageConfigurator();
...
//		
//		BasicPackageConfigurator testPackageConfigurator = new BasicPackageConfigurator();
//		registerServiceForCleanup( testPackageConfigurator , new Hashtable<String, Object>(), EPackageConfigurator.class.getName(), ResourceFactoryConfigurator.class.getName());
//		
