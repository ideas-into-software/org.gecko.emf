 ...
 * </p>
 * <ul>
 *   <li>{@link org.geckoprojects.emf.example.model.basic.BusinessPerson#getCompanyIdCardNumber <em>Company Id Card Number</em>}</li>
 *   <li>{@link org.geckoprojects.emf.example.model.basic.BusinessPerson#getEmployeeInfo <em>Employee Info</em>}</li>
 * </ul>
 *
 * @see org.geckoprojects.emf.example.model.basic.BasicPackage#getBusinessPerson()
 * @model
 * @generated
 */
public interface BusinessPerson extends Person {
	 ...
	 * @see org.geckoprojects.emf.example.model.basic.BasicPackage#getBusinessPerson_CompanyIdCardNumber()
	...
	/**
	 * Sets the value of the '{@link org.geckoprojects.emf.example.model.basic.BusinessPerson#getCompanyIdCardNumber <em>Company Id Card Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.geckoprojects.emf.example.model.basic.EmployeeInfo}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Employee Info</em>' containment reference list.
	 * @see org.geckoprojects.emf.example.model.basic.BasicPackage#getBusinessPerson_EmployeeInfo()
